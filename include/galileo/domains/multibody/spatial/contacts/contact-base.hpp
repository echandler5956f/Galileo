#ifndef __galileo_multibody_spatial_contacts_contact_base_hpp__
#define __galileo_multibody_spatial_contacts_contact_base_hpp__
...
namespace galileo
{
    ...
    protected:
        ...
        inline ContactDataBase(const ContactDataBase &clone) : Base(clone) { *this = clone; }

        inline ContactDataBase &operator=(const ContactDataBase &clone) { return *this; }
    ...
    public:
        ...
        const DimNC_t &get_nc_dim() const { return this->derived().get_nc_dim_impl(); }
        const DimNC_t &get_nc_dim_impl() const { return nc_dim_; }
...
#endif // __galileo_multibody_spatial_contacts_contact_base_hpp__
