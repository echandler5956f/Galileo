#ifndef __galileo_multibody_spatial_contacts_contact_manager_hpp__
#define __galileo_multibody_spatial_contacts_contact_manager_hpp__

#include "galileo/common/container/manager-base.hpp"

#include "galileo/domains/multibody/spatial/contacts/contact-base.hpp"
#include "galileo/domains/multibody/spatial/contacts/contact-generic.hpp"
...
namespace galileo
{
    ...
    public:
        ...
        ContactModelManagerTpl(const PS &ps, const State_t &state) : Base(), ps_(ps), state_(state) {}
...
#endif // __galileo_multibody_spatial_contacts_contact_manager_hpp__
