#ifndef __galileo_multibody_spatial_impulses_fwd_hpp__
#define __galileo_multibody_spatial_impulses_fwd_hpp__
...
#endif // __galileo_multibody_spatial_impulses_fwd_hpp__
