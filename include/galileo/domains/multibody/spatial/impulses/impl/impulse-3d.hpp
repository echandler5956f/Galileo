#ifndef __galileo_multibody_spatial_impulses_impulse_3d_hpp__
#define __galileo_multibody_spatial_impulses_impulse_3d_hpp__
...
namespace galileo
{
    ...
    public:
        ...
        ImpulseData3dTpl(const Model_t &model, MemoryArena &arena, RobotData_t *const robot_data)
            : robot(robot_data),
              frame(model.get_id()),
              type(model.get_type()),
    ...
    public:
        ...
        ImpulseModel3dTpl(const PS &ps, const State_t &state, const FrameIndex_t id, const ReferenceFrame_t &type)
...
#endif // __galileo_multibody_spatial_impulses_impulse_3d_hpp__
