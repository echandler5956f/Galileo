...
namespace galileo
{
    ...
    namespace multibody
    {
            ...
            : fusion::ContactUnaryVisitorBase<ContactCalcZerothOrderVisitor<PhaseSpec, ContactCollectionTpl, StateVectorType>>
        {
            ...
            static void algo(
                const multibody::ContactModelBase<ContactModel, PhaseSpec> &contact_model,
                typename multibody::ContactDataBase<typename ContactModel::ContactDataDerived, PhaseSpec> &contact_data,
