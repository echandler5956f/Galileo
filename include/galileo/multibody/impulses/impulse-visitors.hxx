...
namespace galileo
{
    ...
    struct ImpulseCalcZerothOrderVisitor
        : fusion::ImpulseUnaryVisitorBase<ImpulseCalcZerothOrderVisitor<PhaseSpec, ImpulseCollectionTpl, StateVectorType>>
    {
    ...
    template <typename PhaseSpec,
              template <typename PS> class ImpulseCollectionTpl,
              typename StateVectorType>
    inline void impulse_calc_zeroth_order(
    ...
    struct ImpulseCalcFirstOrderVisitor
        : fusion::ImpulseUnaryVisitorBase<ImpulseCalcFirstOrderVisitor<PhaseSpec, ImpulseCollectionTpl, StateVectorType>>
    {
        using ArgsType = boost::fusion::vector<const StateVectorType &>;
    ...
    template <typename PhaseSpec,
              template <typename PS> class ImpulseCollectionTpl,
              typename StateVectorType>
    inline void impulse_calc_first_order(
        const ImpulseModelTpl<PhaseSpec, ImpulseCollectionTpl> &impulse_model,
        ImpulseDataTpl<PhaseSpec, ImpulseCollectionTpl> &impulse_data,
        const Eigen::MatrixBase<StateVectorType> &x)
    {
    ...
    template <typename PhaseSpec,
              template <typename PS> class ImpulseCollectionTpl,
              typename ForceVectorType>
    inline void impulse_update_force(
        const ImpulseModelTpl<PhaseSpec, ImpulseCollectionTpl> &impulse_model,
        ImpulseDataTpl<PhaseSpec, ImpulseCollectionTpl> &impulse_data,
        const Eigen::MatrixBase<ForceVectorType> &force)
    {
    ...
    template <typename PhaseSpec,
              template <typename PS> class ImpulseCollectionTpl>
    inline void impulse_set_zero_force(
        const ImpulseModelTpl<PhaseSpec, ImpulseCollectionTpl> &impulse_model,
        ImpulseDataTpl<PhaseSpec, ImpulseCollectionTpl> &impulse_data)
    {
    ...
    template <typename PhaseSpec,
              template <typename PS> class ImpulseCollectionTpl>
    inline void impulse_set_zero_force_diff(
        const ImpulseModelTpl<PhaseSpec, ImpulseCollectionTpl> &impulse_model,
        ImpulseDataTpl<PhaseSpec, ImpulseCollectionTpl> &impulse_data)
    {
    ...
    template <typename PhaseSpec,
              template <typename> class ImpulseCollectionTpl>
                                          ...
                                          ImpulseDataTpl<PhaseSpec, ImpulseCollectionTpl>>
    {
        ...
        template <typename ImpulseModelType>
        static ImpulseDataVariant_t algo(
            const ImpulseModelBase<ImpulseModelType, PhaseSpec> &impulse_model,
    ...
    {
        using ArgsType = boost::fusion::vector<const typename ImpulseModelTpl<PhaseSpec, ImpulseCollectionTpl>::FrameIndex_t &>;
    ...
    template <typename PhaseSpec,
              template <typename PS> class ImpulseCollectionTpl>
    struct ImpulseGetTypeVisitor : boost::static_visitor<typename ImpulseModelTpl<PhaseSpec, ImpulseCollectionTpl>::ReferenceFrame_t>
    {
    ...
    {
        using ArgsType = boost::fusion::vector<const typename ImpulseModelTpl<PhaseSpec, ImpulseCollectionTpl>::ReferenceFrame_t &>;
    ...
    template <typename PhaseSpec,
              template <typename PS> class ImpulseCollectionTpl>
    struct ImpulseRobotDataVisitor : boost::static_visitor<typename ImpulseDataTpl<PhaseSpec, ImpulseCollectionTpl>::RobotData_t>
    {
    ...
    template <typename PhaseSpec,
              template <typename PS> class ImpulseCollectionTpl>
    struct ImpulseFrameVisitor : boost::static_visitor<typename ImpulseDataTpl<PhaseSpec, ImpulseCollectionTpl>::FrameIndex_t>
    {
    ...
    template <typename PhaseSpec,
              template <typename PS> class ImpulseCollectionTpl>
    struct ImpulseTypeDataVisitor : boost::static_visitor<typename ImpulseDataTpl<PhaseSpec, ImpulseCollectionTpl>::ReferenceFrame_t>
    {
    ...
    template <typename PhaseSpec,
              template <typename PS> class ImpulseCollectionTpl>
    struct ImpulseJcVisitor : boost::static_visitor<typename ImpulseDataTpl<PhaseSpec, ImpulseCollectionTpl>::MatrixNcNv_t>
    {
    ...
    template <typename PhaseSpec,
              template <typename PS> class ImpulseCollectionTpl>
    struct ImpulsedFdXVisitor : boost::static_visitor<typename ImpulseDataTpl<PhaseSpec, ImpulseCollectionTpl>::MatrixNcNdx_t>
    {
    ...
    template <typename PhaseSpec,
              template <typename PS> class ImpulseCollectionTpl>
    struct ImpulsedFdUVisitor : boost::static_visitor<typename ImpulseDataTpl<PhaseSpec, ImpulseCollectionTpl>::MatrixNcNu_t>
    {
    ...
    template <typename PhaseSpec,
              template <typename PS> class ImpulseCollectionTpl>
    struct ImpulseFXjVisitor : boost::static_visitor<typename ImpulseDataTpl<PhaseSpec, ImpulseCollectionTpl>::ActionMatrix_t>
    {
    ...
    template <typename PhaseSpec,
              template <typename PS> class ImpulseCollectionTpl>
    struct ImpulseDtauDqVisitor : boost::static_visitor<typename ImpulseDataTpl<PhaseSpec, ImpulseCollectionTpl>::MatrixNv_t>
    {
...
#endif // __galileo_multibody_impulses_impulse_visitors_hxx__
