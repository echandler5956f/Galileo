...
namespace galileo
{
    ...
    public:
        ...
        {
            return galileo::impulse_robot_data(*this);
        }

        FrameIndex_t frame() const
        {
            return galileo::impulse_frame(*this);
        }

        ReferenceFrame_t type() const
        {
            return galileo::impulse_type_data(*this);
        }

        SE3_t jMf() const
        {
            return galileo::impulse_jMf(*this);
        }

        MatrixNcNv_t Jc() const
        {
            return galileo::impulse_Jc(*this);
        }

        Force_t f() const
        {
            return galileo::impulse_f(*this);
        }

        Force_t fext() const
        {
            return galileo::impulse_fext(*this);
        }

        MatrixNcNdx_t df_dx() const
        {
            return galileo::impulse_df_dx(*this);
        }

        MatrixNcNu_t df_du() const
        {
            return galileo::impulse_df_du(*this);
        }
        ...
        {
            return galileo::impulse_dtau_dq(*this);
        }
        ...
        ImpulseDataTpl(const DataVariant_t &data_variant)
    ...
    public:
        ...
        ImpulseModelTpl(const ModelVariant_t &model_variant)
        ...
        {
            return galileo::impulse_create_data(*this, robot);
        }
        ...
        {
            galileo::impulse_set_zero_force(*this, data);
        }

        void setZeroForceDiffImpl(Data_t &data) const
        {
            galileo::impulse_set_zero_force_diff(*this, data);
        }

        const RobotModel_t &get_robot() const
        {
            return galileo::impulse_get_robot(*this);
        }
        ...
        {
            return galileo::impulse_get_ps(*this);
        }

        FrameIndex_t get_id_impl() const
        {
            return galileo::impulse_get_id(*this);
        }

        void set_id_impl(const FrameIndex_t &id)
        {
            galileo::impulse_set_id(*this, id);
        }

        ReferenceFrame_t get_type_impl() const
        {
            return galileo::impulse_get_type(*this);
        }

        void set_type_impl(const ReferenceFrame_t &type)
        {
            galileo::impulse_set_type(*this, type);
        }

        int get_nc_impl() const
        {
            return galileo::impulse_get_nc(*this);
        }
