#ifndef __galileo_reactive_prox_qp_solver_model_hpp__
#define __galileo_reactive_prox_qp_solver_model_hpp__
...
namespace galileo
{
    namespace reactive
    {
        ...
        struct ProxQPSolverModel : QPSolverModelBase<ProxQPSolverModel<Scalar, Nx, Ne, Ni, Options>>
        {
        public:
...
#endif // __galileo_reactive_prox_qp_solver_model_hpp__