#ifndef __galileo_reactive_qp_solvers_qpoases_solver_hpp__
#define __galileo_reactive_qp_solvers_qpoases_solver_hpp__
...
namespace galileo
{
    ...
    namespace reactive
    {
        ...
        class QPOASESSolver : QPSolverModelBase<QPOASESSolver<Scalar, Nx, Ne, Ni, Options>>
        {
        public:
...
#endif // __galileo_reactive_qp_solvers_qpoases_solver_hpp__