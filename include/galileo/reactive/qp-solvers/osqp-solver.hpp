#ifndef __galileo_reactive_qp_solvers_osqp_solver_hpp__
#define __galileo_reactive_qp_solvers_osqp_solver_hpp__
...
namespace galileo
{
    ...
    namespace reactive
    {
        ...
        class OSQPSolver : QPSolverModelBase<OSQPSolver<Scalar, Nx, Ne, Ni, Options>>
        {
        public:
...
#endif // __galileo_reactive_qp_solvers_osqp_solver_hpp__