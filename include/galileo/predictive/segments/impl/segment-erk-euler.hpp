...
namespace galileo
{
    ...
    public:
        ...
        using NodeModel_t = typename PS::NodeModel_t;
        using ControlParamModel_t = typename PS::ControlParamModel_t;
        ...
        using MatrixNvNdx_t = typename PS::MatrixNvNdx_t;
        using MatrixNvNw_t = typename PS::MatrixNvNw_t;
        ...
        SegmentERKModelEulerTpl(const PS &ps,
            ...
            : Base(ps, state), node_(node), control_(control), period_(period), period_squared_(period * period)
        {
        }
