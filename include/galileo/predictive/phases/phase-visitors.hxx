...
namespace galileo
{
        ...
        : fusion::PhaseUnaryVisitorBase<PhaseCalcZerothOrderVisitor<BasicSpec, StateMatrixType, ControlParamMatrixType>>
    {
        ...
        static void algo(const PhaseModelBase<PhaseModelType, BasicSpec> &phase_model,
    ...
    inline void phase_calc_zeroth_order(const PhaseModelTpl<BasicSpec, PhaseCollectionTpl> &phase_model,
    ...
    template <typename BasicSpec,
              ...
              typename StateMatrixType,
              typename ControlParamMatrixType>
    inline void phase_calc_first_order(const PhaseModelTpl<BasicSpec, PhaseCollectionTpl> &phase_model,
                                       PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data,
                                       const Eigen::MatrixBase<StateMatrixType> &xs,
                                       const Eigen::MatrixBase<ControlParamMatrixType> &ws)
    {
    ...
    {
        using ArgsType = boost::fusion::
            vector<const StateMatrixType &, ControlParamMatrixType &, const int, const typename BasicSpec::NumScalar>;
    ...
    template <typename BasicSpec,
              ...
              typename StateMatrixType,
              typename ControlParamMatrixType>
    inline void phase_quasi_static(const PhaseModelTpl<BasicSpec, PhaseCollectionTpl> &phase_model,
                                   PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data,
                                   const Eigen::MatrixBase<StateMatrixType> &xs,
                                   Eigen::MatrixBase<ControlParamMatrixType> &ws,
                                   const int maxiter,
    ...
    struct PhaseCreateDataVisitor : fusion::PhaseUnaryVisitorBase<PhaseCreateDataVisitor<BasicSpec, PhaseCollectionTpl>,
                                                                  PhaseDataTpl<BasicSpec, PhaseCollectionTpl>>
    {
        ...
        template <typename PhaseModelType>
        static PhaseDataVariant_t algo(const PhaseModelBase<PhaseModelType, BasicSpec> &phase_model)
        {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseXNextVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::XNext_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::XNext_t phase_XNext_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseXNextxVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::XNextx_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::XNextx_t phase_XNextx_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseXNextwVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::XNextw_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::XNextw_t phase_XNextw_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseLVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::L_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::L_t phase_L_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseLxVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Lx_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Lx_t phase_Lx_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseLwVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Lw_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Lw_t phase_Lw_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseLxxVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Lxx_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Lxx_t phase_Lxx_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseLxwVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Lxw_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Lxw_t phase_Lxw_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseLwwVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Lww_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Lww_t phase_Lww_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseHVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::H_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::H_t phase_H_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseHxVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Hx_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Hx_t phase_Hx_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseHwVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Hw_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Hw_t phase_Hw_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseGVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::G_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::G_t phase_G_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseGxVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Gx_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Gx_t phase_Gx_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    struct PhaseGwVisitor : boost::static_visitor<typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Gw_t>
    {
    ...
    template <typename BasicSpec, template <typename> class PhaseCollectionTpl>
    inline typename PhaseDataTpl<BasicSpec, PhaseCollectionTpl>::Gw_t phase_Gw_at_seg_i(
        const PhaseDataTpl<BasicSpec, PhaseCollectionTpl> &phase_data, const int i)
    {
