...
namespace galileo
{
    ...
    struct PhaseDataDefaultTpl
        : public PhaseDataBase<PhaseDataDefaultTpl<PhaseSpec>, PhaseSpec>
    {
    public:
        using PS = PhaseSpec;
        ...
        using Model_t = typename traits<Meta_t>::Model_t;
        using Data_t = typename traits<Meta_t>::Data_t;
        using Base = PhaseDataBase<PhaseDataDefaultTpl<PS>, PS>;
    ...
    class PhaseModelDefaultTpl
        : public PhaseModelBase<PhaseModelDefaultTpl<PhaseSpec>, PhaseSpec>
    {
    public:
        using PS = PhaseSpec;
        ...
        using Model_t = typename traits<Meta_t>::Model_t;
        using Data_t = typename traits<Meta_t>::Data_t;
        using Base = PhaseModelBase<PhaseModelDefaultTpl<PS>, PS>;
