    ...
    namespace fusion
    {
        ...
        struct PhaseUnaryVisitorBase
        {
            ...
            static ReturnType run(
                const galileo::predictive::PhaseModelTpl<PhaseSpec, PhaseCollectionTpl> &phase_model,
                galileo::predictive::PhaseDataTpl<PhaseSpec, PhaseCollectionTpl> &phase_data,
                ArgsTmp args)
            {
                InternalVisitorModelAndData<galileo::predictive::PhaseModelTpl<PhaseSpec, PhaseCollectionTpl>, ArgsTmp>
            ...
            static ReturnType run(
                ...
                galileo::predictive::PhaseDataTpl<PhaseSpec, PhaseCollectionTpl> &phase_data)
            {
                InternalVisitorModelAndData<galileo::predictive::PhaseModelTpl<PhaseSpec, PhaseCollectionTpl>, NoArg>
                    visitor(phase_data);
                return boost::apply_visitor(visitor, phase_model);
            }
            ...
            static ReturnType run(
                const galileo::predictive::PhaseModelBase<PhaseModelDerived, typename traits<PhaseModelDerived>::PS> &phase_model,
                typename galileo::predictive::PhaseModelBase<PhaseModelDerived, typename traits<PhaseModelDerived>::PS>::PhaseDataDerived &phase_data,
                ArgsTmp args)
            {
            ...
            template <
                ...
                typename ArgsTmp>
            static ReturnType
            run(const galileo::predictive::PhaseModelTpl<PhaseSpec, PhaseCollectionTpl> &phase_model, ArgsTmp args)
            {
            ...
            template <
                ...
                typename ArgsTmp>
            static ReturnType
            run(const galileo::predictive::PhaseDataTpl<PhaseSpec, PhaseCollectionTpl> &phase_data, ArgsTmp args)
            {
                InternalVisitorModel<ArgsTmp> visitor(args);
            ...
            template <typename PhaseSpec, template <typename PS> class PhaseCollectionTpl>
            static ReturnType run(const galileo::predictive::PhaseModelTpl<PhaseSpec, PhaseCollectionTpl> &phase_model)
            {
            ...
            template <typename PhaseSpec, template <typename PS> class PhaseCollectionTpl>
            static ReturnType run(const galileo::predictive::PhaseDataTpl<PhaseSpec, PhaseCollectionTpl> &phase_data)
            {
                InternalVisitorModel<NoArg> visitor;
                return boost::apply_visitor(visitor, phase_data);
            }
            ...
            template <typename PhaseModelDerived, typename ArgsTmp>
            static ReturnType run(const galileo::predictive::PhaseModelBase<PhaseModelDerived, typename traits<PhaseModelDerived>::PS> &phase_model, ArgsTmp args)
            {
                InternalVisitorModel<ArgsTmp> visitor(args);
                return visitor(phase_model.derived());
            }
            ...
            static ReturnType run(const galileo::predictive::PhaseDataBase<PhaseDataDerived, typename traits<PhaseDataDerived>::PS> &phase_data, ArgsTmp args)
            {
                InternalVisitorModel<ArgsTmp> visitor(args);
            ...
            template <typename PhaseModelDerived>
            static ReturnType run(const galileo::predictive::PhaseModelBase<PhaseModelDerived, typename traits<PhaseModelDerived>::PS> &phase_model)
            {
                InternalVisitorModel<NoArg> visitor;
                return visitor(phase_model.derived());
            }
            ...
            static ReturnType run(const galileo::predictive::PhaseDataBase<PhaseDataDerived, typename traits<PhaseDataDerived>::PS> &phase_data)
            {
                InternalVisitorModel<NoArg> visitor;
                return visitor(phase_data.derived());
            }
        ...
        private:
            ...
            struct InternalVisitorModelAndData : public boost::static_visitor<ReturnType>
            {
                ...
                template <typename PhaseModelDerived>
                ReturnType operator()(const galileo::predictive::PhaseModelBase<PhaseModelDerived, typename traits<PhaseModelDerived>::PS> &phase_model) const
                {
                    return bf::invoke(
                        ...
                        bf::append(
                            ...
                            boost::ref(
                                boost::get<typename galileo::predictive::PhaseModelBase<PhaseModelDerived, typename traits<PhaseModelDerived>::PS>::PhaseDataDerived>(phase_data)),
                            args));
                }
            ...
            struct InternalVisitorModel : public boost::static_visitor<ReturnType>
            {
                ...
                template <typename PhaseDataDerived>
                ReturnType operator()(const galileo::predictive::PhaseDataBase<PhaseDataDerived, typename traits<PhaseDataDerived>::PS> &phase_data) const
                {
                    return bf::invoke(
