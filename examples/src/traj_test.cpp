...
int main(int argc, char **argv)
{
    ...
    casadi::SX Q = casadi::SX::zeros(si->nx, si->nx);
    ...
    X_ref(si->nh + si->ndh + 1) = 0.075;
    casadi::SX x_error = robot.cx - X_ref;
    ...
    Eigen::VectorXd new_times = Eigen::VectorXd::LinSpaced(100, 0, 1.);
