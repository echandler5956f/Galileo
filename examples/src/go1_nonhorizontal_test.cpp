...
int main(int argc, char **argv)
{
    ...
    surfaces->push_back(environment::createInfiniteSurface( 3.14159/2, {0, 1, 0}, {0.6, 0, 0} ));

    std::vector<int> knot_num = {20, 20, 20, 20, 20, 
                                20, 20, 20, 20};
    std::vector<double> knot_time = {0.05, 0.3, 0.05, 0.3, 0.05, 
                                    0.3, 0.05, 0.3, 0.05};
    std::vector<int> mask_vec = {0b1111, 0b0111, 0b1111, 0b1101, 0b1111, //Wall mount
                                0b1011, 0b1111, 0b1110, 0b1111}; // Static walk

    std::vector<std::vector<environment::SurfaceID> contact_surfaces = 
        {   {0, 0, 0, 0}, 
            {0, 0, environment::NO_SURFACE, 0}, {0, 0, 1, 0}, 
            {environment::NO_SURFACE, 0, 1, 0}, {1, 0, 1, 0}, // Wall mount
            {1, environment::NO_SURFACE, 1, 0}, {1, 0, 1, 0}, 
            {1, 0, 1, environment::NO_SURFACE}, {1, 0, 1, 0} // Static walk
            }; // Put legs against wall then walk
