...
TEST_CASE("ActuationModelFloatingBaseTpl - Basic Construction", "[floating_base][construction]")
{
    SECTION("Fixed dimensions construction")
    {
        ...
        REQUIRE(fixture.actuation_model_->get_nua() == fixture.rs_.NUa);
        REQUIRE(fixture.actuation_model_->get_nua() == FloatingBaseTestFixture<double>::NVj + FloatingBaseTestFixture<double>::NRotors);
        REQUIRE(fixture.actuation_model_->get_nua() == 12); // 12 + 0
    ...
    SECTION("Different floating base configurations")
    {
        ...
        // Test with no rotors
        {
            ...
            REQUIRE(model.get_nua() == 12); // Only joint actuations
        }
        ...
        // Test with many rotors
        {
            ...
            REQUIRE(model.get_nua() == 16); // 12 joint + 4 rotor actuations
        }
    }
}
...
TEST_CASE("ActuationModelFloatingBaseTpl - Dynamic Dimensions", "[floating_base][dynamic]")
{
    SECTION("Dynamic robot spec")
    {
        ...
        rs.NQj_dim.set_value(15);
        rs.NVb_dim.set_value(6);
        rs.NVj_dim.set_value(15);
        rs.NRotors_dim.set_value(3);
        rs.NQ_dim.set_value(21);
        rs.NV_dim.set_value(21);
        rs.NX_dim.set_value(42);
        rs.NDX_dim.set_value(42);
        rs.NUa_dim.set_value(18); // 15 + 3
...
TEST_CASE("ActuationModelFloatingBaseTpl - DimensionTpl Integration", "[floating_base][dimensions]")
{
    SECTION("Compile-time dimension verification")
    {
        ...
        REQUIRE(fixture.actuation_model_->get_nua() == FloatingBaseTestFixture<double>::RS::NUa);
    ...
    SECTION("Mixed compile-time and dynamic dimensions")
    {
        ...
        rs.NQj_dim.set_value(12);
        rs.NVj_dim.set_value(12);
        rs.NQ_dim.set_value(18);
        rs.NV_dim.set_value(18);
        rs.NX_dim.set_value(36);
        rs.NDX_dim.set_value(36);
        rs.NUa_dim.set_value(12); // 12 + 0
...
TEST_CASE("ActuationModelFloatingBaseTpl - Thread Safety", "[floating_base][thread_safety]")
{
    SECTION("Const-correctness")
    {
        ...
        // Test const methods
        REQUIRE(const_model.get_nua() == fixture.rs_.NUa);
