...
namespace galileo
{
    namespace opt
    {
        ...
        void PseudospectralSegment::Update(const double start_time, const double h, casadi::DM X0_param, casadi::DM Xf_param)
        {
            ResetNLPData();
            UpdateTimeVectors(start_time, h);
            UpdateBounds();
        ...
        void PseudospectralSegment::UpdateNLPData(NLPData &nlp_data)
        {
