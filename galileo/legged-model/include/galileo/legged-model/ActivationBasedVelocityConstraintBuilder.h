    ...
    namespace legged
    {
        namespace constraints
        {
            ...
            public:
                 ...
                 *
                 */
                void footstepVelocityFunction(casadi::SX &t, const FootstepDefinition &FS_def, casadi::Function &h1_dot_desired, casadi::Function &h2_dot_desired, double actual_duration)
                {
                    ...
                    h1_dot_desired = casadi::Function("h1_dot_desired", {t}, {(FS_def.h_offset_P1 / (FS_def.h1_window_duration * actual_duration)) * mapped_bell_curve(casadi::SXVector{t / FS_def.h1_window_duration}).at(0)});
