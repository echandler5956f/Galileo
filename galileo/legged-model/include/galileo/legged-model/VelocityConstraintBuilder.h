        ...
        namespace constraints
        {
            ...
            casadi::Function GetMappedBellCurve(casadi::SX &t, double window_sigma )
            {
                ...
                casadi::Function mapped_bell_curve = casadi::Function("mapped_bell_curve", {t},
                                                                      {bell_curve((t - 0.5) * (2 * window_sigma)) / bell_curve(casadi::SX({0}))});
            ...
            public:
                ...
                */
                void FootstepVelocityFunction(casadi::SX &t, const FootstepDefinition &FS_def, casadi::Function& h1_dot_desired, casadi::Function& h2_dot_desired)
                {
                    ...
                    casadi::SX mapped_bell_curve = GetMappedBellCurve(t, window_sigma);

                    h1_dot_desired = casadi::Function("h1_dot_desired", {t}, {mapped_bell_curve(t / FS_def.h1_window_duration)});
                    h2_dot_desired = casadi::Function("h2_dot_desired", {t}, {mapped_bell_curve((1 - t) / FS_def.h2_window_duration)});
                }
