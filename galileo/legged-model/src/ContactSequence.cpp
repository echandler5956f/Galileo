...
namespace galileo
{
    namespace legged
    {
        namespace contact
        {
            ...
            void ContactMode::createModeDynamics(opt::Model model, RobotEndEffectors end_effectors, std::shared_ptr<opt::LeggedRobotStates> states)
            {
                ...
                ModeDynamics_ = casadi::Function("F_mode", casadi::SXVector{}, casadi::SXVector{});
            }

            void ContactMode::getModeDynamics(casadi::Function &f)
            {
                f = ModeDynamics_;
            }
