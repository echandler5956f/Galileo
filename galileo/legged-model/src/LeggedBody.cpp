...
namespace galileo
{
    namespace legged
    {
        ...
        /*So, for some reason, pinocchio's integrate function returns a slightly different casadi matrix than than the python version.
        ...
        casadi::SX LeggedBody::customFint(casadi::SX x, casadi::SX dx, casadi::SX dt)
        {
            ...
            {
                dq = vertcat(casadi::SXVector{dq, x(i) + (dx(i - 1) * dt)});
            }
